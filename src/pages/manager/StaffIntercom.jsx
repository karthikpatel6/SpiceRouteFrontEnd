...
export default function StaffIntercom() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex' }}>
      {/* Sidebar */}
      <aside style={{ width: 220, background: '#0d0a06', borderRight: '1px solid rgba(232,163,23,0.1)', padding: '20px 14px', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
      ...
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: 0 }}>
        ...
        <div style={{ padding: '20px 24px', borderBottom: '1px solid rgba(232,163,23,0.08)' }}>
          ...
          <p style={{ color: '#6B5E50', fontSize: '0.8rem' }}>Real-time Kitchen ↔ Manager communication. All messages are persisted.</p>
        </div>
        ...
        <div style={{ padding: '14px 24px', borderTop: '1px solid rgba(232,163,23,0.08)', display: 'flex', gap: 10 }}>
          <input
            ...
            placeholder="Type a message to kitchen or manager..."
            style={{
